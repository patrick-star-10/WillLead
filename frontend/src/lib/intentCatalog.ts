...
const primarySwapFaucetDemoIntent = {
  ...
  triggerEvent: 'Swap',
  listenerAddress: '0x9468749b06862883e6808907800510c83f2EaAE5',
  executionContractAddress: '0x18F1B7489763fA108A43B2Df40b70b2185d4E10F',
  ...
  executionAction: 'request(address) on the Reactive faucet',
